...
from fastapi import Depends, FastAPI, HTTPException, status, File, UploadFile, APIRouter, Request
...
async def audit_log(request: Request, call_next):
    ...
    if "request_body" in context:
        ...
        print('Request Body : {}'.format(context["request_body"]))
...
#     result = {"client_host": client_host }
#     print("result", result)
#     return result
